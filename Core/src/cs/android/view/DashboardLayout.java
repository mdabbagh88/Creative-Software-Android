 ...
 * http://code.google.com/p/iosched/source
 * /browse/android/src/com/google/android/apps/iosched/ui/
 * widget/DashboardLayout.java
 */
public class DashboardLayout extends ViewGroup {
	...
	@Override protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		for (int i = 0; i < count; i++) {
			...
			child.layout(left, top, hSpace == 0 && col == cols - 1 ? r : left + width, vSpace == 0
					&& row == rows - 1 ? b : top + height);
			++visibleIndex;
		}
	}
