...
public abstract class JSONImplBase implements JSON {
	@Override
	public JSONObject create(Map<String, String> value) {
	...
	@Override
	public <T extends JSONData> JSONArray create(List<T> objects) {
	...
	@Override
	public <T extends JSONData> JSONObject createJSONDataMap(Map<String, T> value) {
		JSONObject object = createObject();
